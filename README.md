About opentelemetry-instrumentation-milvus-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-milvus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-milvus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-milvus
# for installing globally
pixi global install opentelemetry-instrumentation-milvus
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-milvus` available on your platform:
...
```
pixi search opentelemetry-instrumentation-milvus --channel conda-forge
```
